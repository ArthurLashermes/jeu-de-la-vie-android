...
public class Stub {
    ...
    public HashMap<String, Dieu> Loader(Context cont) {
        HashMap<String, Dieu> lesConfig = new HashMap<>();
        Monde monde2 = new Monde(cont,10, 10);
        ...
        Dieu dieu2 = new Dieu(rules2,monde2);
    ...
    public HashMap<String, Monde> LoadMonde(Context cont) {
        HashMap<String, Monde> DicoMonde = new HashMap<>();
        Monde monde = new Monde(cont, 10,10);
